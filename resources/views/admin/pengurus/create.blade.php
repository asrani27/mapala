...
@section('title', 'Tambah Pengurus — MAPALA Admin')

@section('content')
<div class="mb-8">
    <h1 class="font-display-lg text-headline-md text-primary uppercase">Tambah Pengurus</h1>
    <p class="font-body-md text-on-surface-variant mt-1">Tambah data pengurus baru MAPALA.</p>
</div>
