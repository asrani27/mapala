...
@section('title', 'Tambah Anggota — MAPALA Admin')
...
<div class="mb-8">
    ...
    <h1 class="font-display-lg text-headline-md text-primary uppercase">Tambah Anggota</h1>
    <p class="font-body-md text-on-surface-variant mt-1">Tambah data anggota baru.</p>
</div>
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" id="tanggal_daftar" name="tanggal_daftar" value="{{ old('tanggal_daftar') }}" required
            ...
            <div>
                ...
                <textarea id="alamat" name="alamat" rows="3"
                    class="w-full px-4 py-3 bg-surface-container-lowest border-2 border-outline rounded-lg font-body-md text-on-surface placeholder:text-outline focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all @error('alamat') border-error @enderror">{{ old('alamat') }}</textarea>
            ...
            <div>
                ...
                <p class="font-body-sm text-on-surface-variant mt-1">Format: JPG, PNG, GIF (Maks. 2MB)</p>
            </div>
