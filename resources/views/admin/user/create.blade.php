...
@section('title', 'Tambah User — MAPALA Admin')
...
<div class="mb-8">
    ...
    <h1 class="font-display-lg text-headline-md text-primary uppercase">Tambah User</h1>
    <p class="font-body-md text-on-surface-variant mt-1">Buat akun pengguna baru.</p>
</div>
...
<div class="max-w-2xl bg-surface rounded-lg border-2 border-outline p-8">
    <form method="POST" action="{{ route('admin.user.store') }}">
        ...
        <div class="space-y-6">
            ...
            <div>
                <label for="password" class="font-label-caps text-label-caps text-primary mb-2 block">Password</label>
                <div class="relative">
                    <input type="password" id="password" name="password" required autocomplete="new-password"
                        class="w-full px-4 py-3 pr-12 bg-surface-container-lowest border-2 border-outline rounded-lg font-body-md text-on-surface placeholder:text-outline focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all @error('password') border-error @enderror" />
            ...
            <div>
                ...
                <div class="relative">
                    <input type="password" id="password_confirmation" name="password_confirmation" required
                        ...
                        class="w-full px-4 py-3 pr-12 bg-surface-container-lowest border-2 border-outline rounded-lg font-body-md text-on-surface placeholder:text-outline focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all" />
