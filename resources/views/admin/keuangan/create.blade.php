...
@section('title', 'Tambah Keuangan — MAPALA Admin')
...
<div class="mb-8">
    ...
    <h1 class="font-display-lg text-headline-md text-primary uppercase">Tambah Transaksi Keuangan</h1>
    <p class="font-body-md text-on-surface-variant mt-1">Tambahkan transaksi keuangan baru.</p>
</div>
    ...
    <form method="POST" action="{{ route('admin.keuangan.store') }}">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" id="keterangan" name="keterangan" value="{{ old('keterangan') }}" placeholder="Contoh: Pembayaran Iuran"
            ...
            <div>
                ...
                <input type="number" id="debit" name="debit" value="{{ old('debit', 0) }}" min="0" step="1000"
                    placeholder="0"
            ...
            <div>
                ...
                <input type="number" id="kredit" name="kredit" value="{{ old('kredit', 0) }}" min="0" step="1000"
                    placeholder="0"
